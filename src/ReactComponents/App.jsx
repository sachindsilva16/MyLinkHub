        ...
        function App() {
            return (
                <div>
                        ...
                        <h1 className="text-center text-4xl pt-[20px] pl-8 pr-8 md:font-bold bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text sm:font-[1100] font-extrabold">Your Frequent Taps In One Place.</h1>
