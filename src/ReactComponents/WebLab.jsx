...
<div className="flex items-center flex-col mb-8 border-1 h-[240px] px-8 md:px-8 justify-center rounded-md shadow-md shadow-[#C0C0C0] md:mx-6 md:h-[300px]">
<p className="mb-4 ml-0 mt-12 mr-0 text-xl font-semibold text-[#C0C0C0] text-center px-[30px]  ">Web Lab MSE1
